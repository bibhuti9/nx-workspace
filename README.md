...
Run `npx nx serve rnnx` to start the development server. Happy coding!

## Build for production

Run `npx nx build rnnx` to build the application. The build artifacts are stored in the output directory (e.g. `dist/` or `build/`), ready to be deployed.
